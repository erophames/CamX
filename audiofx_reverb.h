#ifndef CAMX_AUDIOINTERN_REVERB
#define CAMX_AUDIOINTERN_REVERB 1
...
static int sox_reverb_start(eff_t effp)
{
        ...
        reverb->reverbbuf = (float *) xmal(sizeof (float) * reverb->maxsamples);
...
class audioobject_Intern_Reverb:public audioobject_Intern
{
public:
	virtual char *GetName(){return "Reverb";}
};
